...
for "_i" from 1 to 10 do {player addItemToBackpack "SmokeShellBlue";};
for "_i" from 1 to 3 do {player addItemToBackpack "SmokeShell";};
player addItemToBackpack "SmokeShellRed";
player addItemToBackpack "SmokeShellGreen";
for "_i" from 1 to 10 do {player addItemToBackpack "ACE_HandFlare_Yellow";};
...
player setVariable ["ACE_isEngineer", 2];             //1 = Pionier, 2 = Instandsetzer
