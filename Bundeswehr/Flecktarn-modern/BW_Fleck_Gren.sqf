...
for "_i" from 1 to 22 do {player addItemToBackpack "1Rnd_HE_Grenade_shell";};
for "_i" from 1 to 9 do {player addItemToBackpack "1Rnd_Smoke_Grenade_shell";};
for "_i" from 1 to 9 do {player addItemToBackpack "1Rnd_SmokeRed_Grenade_shell";};
