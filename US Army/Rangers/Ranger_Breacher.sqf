...
for "_i" from 1 to 3 do {player addItemToBackpack "tsp_frameCharge_mag";};
for "_i" from 1 to 3 do {player addItemToBackpack "rhsusf_5Rnd_00Buck";};
...
[
    ...
    "",                     //Optik
    ["rhsusf_5Rnd_00Buck", 5],   //Magazin mit Anzahl Kugeln
...
player setVariable ["ACE_isEOD", true, true]; // false = Soldat, true = EOD-Spezialist
