...
player addBackpack "UK3CB_GAF_B_B_RIF_Radio_DIGI";
...
for "_i" from 1 to 2 do {
	player addItemToBackpack "ACE_Chemlight_UltraHiOrange";
};
for "_i" from 1 to 2 do {
...
for "_i" from 1 to 2 do {
	player addItemToBackpack "ACE_HandFlare_White";
};
for "_i" from 1 to 2 do {
	player addItemToBackpack "ACE_HandFlare_Yellow";
};
